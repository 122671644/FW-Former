...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--arch', type=str, default='RetSRFormer', help='archtechture')
        ...
        parser.add_argument('--env', type=str, default='_AISTD', help='env')
        ...
        # train
        parser.add_argument('--train_patch_size', type=int, default=192, help='patch size of training sample')
        parser.add_argument('--train_workers', type=int, default=0, help='train_dataloader workers')
        parser.add_argument('--train_dir', type=str, default=r"E:\Study\Shadow_Dataset\AISTD\train", help='dir of train data')
        ...
        parser.add_argument('--val_dir', type=str, default=r"E:\Study\Shadow_Dataset\AISTD\test", help='dir of test data')
        parser.add_argument('--training_val_epochs', type=int, default=10, help='epochs for val')
