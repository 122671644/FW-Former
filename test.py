...
from ShadowVMamba import ShadowVMamba
...
parser.add_argument('--input_dir', default='/home/comlab/Desktop/ZHUXIUJIN/ISTD/test', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default=r'/home/comlab/Desktop/ZHUXIUJIN/ShadowMamba/log/13_ShadowVMamba_ISTD/results', type=str, help='Directory for results')
parser.add_argument('--weights', default= r'/home/comlab/Desktop/ZHUXIUJIN/ShadowMamba/log/13_ShadowVMamba_ISTD/models/model_epoch_90.pth', type=str, help='Path to weights')
parser.add_argument('--dataset', default='ISTD', type=str, help='Test Dataset')
